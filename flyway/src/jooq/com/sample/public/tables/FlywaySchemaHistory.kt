...
open class FlywaySchemaHistory(
     ...
     */
    val INSTALLED_ON: TableField<Record, LocalDateTime?> = createField(DSL.name("installed_on"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("now()", SQLDataType.LOCALDATETIME)), this, "")
     ...
     */
    val SUCCESS: TableField<Record, Boolean?> = createField(DSL.name("success"), SQLDataType.BOOLEAN.nullable(false), this, "")
    ...
    override fun getIndexes(): List<Index> = listOf(com.sample.`public`.indexes.FLYWAY_SCHEMA_HISTORY_S_IDX)
    override fun getPrimaryKey(): UniqueKey<Record> = com.sample.`public`.keys.FLYWAY_SCHEMA_HISTORY_PK
