...
open class PgLsTmpdir(
    ...
    companion object {
         ...
         */
        val PG_LS_TMPDIR: PgLsTmpdir = PgLsTmpdir()
    }
     ...
     */
    constructor(): this(DSL.name("pg_ls_tmpdir"), null)
    override fun getSchema(): Schema? = if (aliased()) null else PgCatalog.PG_CATALOG
    override fun `as`(alias: String): PgLsTmpdir = PgLsTmpdir(DSL.name(alias), this, parameters)
    override fun `as`(alias: Name): PgLsTmpdir = PgLsTmpdir(alias, this, parameters)

    /**
     * Rename this table
     */
    override fun rename(name: String): PgLsTmpdir = PgLsTmpdir(DSL.name(name), null, parameters)

    /**
     * Rename this table
     */
    override fun rename(name: Name): PgLsTmpdir = PgLsTmpdir(name, null, parameters)
    ...
    fun call(
          tablespace: Long?
    ): PgLsTmpdir = PgLsTmpdir(DSL.name("pg_ls_tmpdir"), null, arrayOf(
        DSL.value(tablespace, SQLDataType.BIGINT)
