...
open class PgConfig(
    ...
    companion object {
         ...
         */
        val PG_CONFIG: PgConfig = PgConfig()
    }
     ...
     */
    constructor(): this(DSL.name("pg_config"), null)
    override fun getSchema(): Schema? = if (aliased()) null else PgCatalog.PG_CATALOG
    override fun `as`(alias: String): PgConfig = PgConfig(DSL.name(alias), this, parameters)
    override fun `as`(alias: Name): PgConfig = PgConfig(alias, this, parameters)

    /**
     * Rename this table
     */
    override fun rename(name: String): PgConfig = PgConfig(DSL.name(name), null, parameters)

    /**
     * Rename this table
     */
    override fun rename(name: Name): PgConfig = PgConfig(name, null, parameters)

    /**
     * Call this table-valued function
     */
    fun call(): PgConfig = PgConfig(DSL.name("pg_config"), null, arrayOf()).let { if (aliased()) it.`as`(unqualifiedName) else it }
}
