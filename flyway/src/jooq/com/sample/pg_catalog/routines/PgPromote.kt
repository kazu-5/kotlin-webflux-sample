...
open class PgPromote : AbstractRoutine<Boolean>("pg_promote", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {
         ...
         */
        val WAIT: Parameter<Boolean?> = Internal.createParameter("wait", SQLDataType.BOOLEAN.defaultValue(DSL.field("true", SQLDataType.BOOLEAN)), true, false)

        /**
         * The parameter <code>pg_catalog.pg_promote.wait_seconds</code>.
         */
        val WAIT_SECONDS: Parameter<Int?> = Internal.createParameter("wait_seconds", SQLDataType.INTEGER.defaultValue(DSL.field("60", SQLDataType.INTEGER)), true, false)
    }
     ...
     */
    fun setWait(value: Boolean?): Unit = setValue(WAIT, value)
     ...
     */
    fun setWaitSeconds(value: Int?): Unit = setValue(WAIT_SECONDS, value)
