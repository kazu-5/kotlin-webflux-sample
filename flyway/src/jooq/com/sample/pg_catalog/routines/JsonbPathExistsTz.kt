...
open class JsonbPathExistsTz : AbstractRoutine<Boolean>("jsonb_path_exists_tz", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.jsonb_path_exists_tz.RETURN_VALUE</code>.
         */
         ...
         */
        val VARS: Parameter<JSONB?> = Internal.createParameter("vars", SQLDataType.JSONB.defaultValue(DSL.field("'{}'::jsonb", SQLDataType.JSONB)), true, false)

        /**
         * The parameter <code>pg_catalog.jsonb_path_exists_tz.silent</code>.
         */
        val SILENT: Parameter<Boolean?> = Internal.createParameter("silent", SQLDataType.BOOLEAN.defaultValue(DSL.field("false", SQLDataType.BOOLEAN)), true, false)
    }
