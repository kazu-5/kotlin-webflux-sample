...
public class PgEventTriggerDroppedObjects extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String[]> ADDRESS_NAMES = createField(DSL.name("address_names"), SQLDataType.CLOB.getArrayDataType(), this, "");

    /**
     * The column
     * <code>pg_catalog.pg_event_trigger_dropped_objects.address_args</code>.
     */
    public final TableField<Record, String[]> ADDRESS_ARGS = createField(DSL.name("address_args"), SQLDataType.CLOB.getArrayDataType(), this, "");
