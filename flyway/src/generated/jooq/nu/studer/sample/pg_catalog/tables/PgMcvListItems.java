...
public class PgMcvListItems extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String[]> VALUES = createField(DSL.name("values"), SQLDataType.CLOB.getArrayDataType(), this, "");

    /**
     * The column <code>pg_catalog.pg_mcv_list_items.nulls</code>.
     */
    public final TableField<Record, Boolean[]> NULLS = createField(DSL.name("nulls"), SQLDataType.BOOLEAN.getArrayDataType(), this, "");
