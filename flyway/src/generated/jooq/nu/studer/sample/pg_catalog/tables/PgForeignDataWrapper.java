...
public class PgForeignDataWrapper extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String[]> FDWACL = createField(DSL.name("fdwacl"), SQLDataType.VARCHAR.getArrayDataType(), this, "");

    /**
     * The column <code>pg_catalog.pg_foreign_data_wrapper.fdwoptions</code>.
     */
    public final TableField<Record, String[]> FDWOPTIONS = createField(DSL.name("fdwoptions"), SQLDataType.CLOB.getArrayDataType(), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.PG_FOREIGN_DATA_WRAPPER_NAME_INDEX, Indexes.PG_FOREIGN_DATA_WRAPPER_OID_INDEX);
    }
